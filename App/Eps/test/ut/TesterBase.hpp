...
namespace App {
    ...
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Connect batteryVoltage to to_batteryVoltage[portNum]
      //!
      void connect_to_batteryVoltage(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          App::InputBatteryLevelPort *const batteryVoltage /*!< The port*/
      );
    ...
    protected:
      ...
      //! Invoke the to port connected to batteryVoltage
      //!
      void invoke_to_batteryVoltage(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
    ...
    public:
      ...
      //! Get the number of to_batteryVoltage ports
      //!
      //! \return The number of to_batteryVoltage ports
      //!
      NATIVE_INT_TYPE getNum_to_batteryVoltage(void) const;
    ...
    protected:
      ...
      //!
      //! Whether to_batteryVoltage[portNum] is connected
      //!
      bool isConnected_to_batteryVoltage(
          const NATIVE_INT_TYPE portNum /*!< The port number*/
      );
    ...
    protected:
      ...
      //! Send a Eps_SetWarningLevel command
      //!
      void sendCmd_Eps_SetWarningLevel(
          const NATIVE_INT_TYPE instance, /*!< The instance number*/
          const U32 cmdSeq, /*!< The command sequence number*/
          U16 voltage /*!< Voltage in mV*/
      );

      //! Send a Eps_SetCriticalLevel command
      //!
      void sendCmd_Eps_SetCriticalLevel(
          const NATIVE_INT_TYPE instance, /*!< The instance number*/
          const U32 cmdSeq, /*!< The command sequence number*/
          U16 voltage /*!< Voltage in mV*/
      );
    ...
    protected:
      ...
      //! Handle event Eps_LowBattery
      //!
      virtual void logIn_WARNING_HI_Eps_LowBattery(
          U16 voltage /*!< Current battery level in mV*/
      );

      //! A history entry for event Eps_LowBattery
      //!
      typedef struct {
        U16 voltage;
      } EventEntry_Eps_LowBattery;

      //! The history of Eps_LowBattery events
      //!
      History<EventEntry_Eps_LowBattery>
        *eventHistory_Eps_LowBattery;
    ...
    protected:
      ...
      //! Handle event Eps_CriticallyLowBattery
      //!
      virtual void logIn_FATAL_Eps_CriticallyLowBattery(
          U16 voltage /*!< Current battery level in mV*/
      );

      //! A history entry for event Eps_CriticallyLowBattery
      //!
      typedef struct {
        U16 voltage;
      } EventEntry_Eps_CriticallyLowBattery;

      //! The history of Eps_CriticallyLowBattery events
      //!
      History<EventEntry_Eps_CriticallyLowBattery>
        *eventHistory_Eps_CriticallyLowBattery;
    ...
    protected:
      ...
      //! Handle channel Eps_BatteryVoltage
      //!
      virtual void tlmInput_Eps_BatteryVoltage(
          const Fw::Time& timeTag, /*!< The time*/
          const U16& val /*!< The channel value*/
      );

      //! A telemetry entry for channel Eps_BatteryVoltage
      //!
      typedef struct {
        Fw::Time timeTag;
        U16 arg;
      } TlmEntry_Eps_BatteryVoltage;

      //! The history of Eps_BatteryVoltage values
      //!
      History<TlmEntry_Eps_BatteryVoltage>
        *tlmHistory_Eps_BatteryVoltage;
    ...
    private:
      ...
      //! To port connected to batteryVoltage
      //!
      App::OutputBatteryLevelPort m_to_batteryVoltage[1];

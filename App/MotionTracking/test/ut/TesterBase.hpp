// ======================================================================
// \title  MotionTracking/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for MotionTracking component test harness base class
//
// \copyright
...
#ifndef MotionTracking_TESTER_BASE_HPP
#define MotionTracking_TESTER_BASE_HPP
...
namespace App {
  ...
  //! \class MotionTrackingTesterBase
  //! \brief Auto-generated base class for MotionTracking component test harness
  //!
  class MotionTrackingTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object MotionTrackingTesterBase
      //!
      virtual void init(
    ...
    public:
      ...
      void connect_to_DataIn(
          ...
          App::InputICMPortPort *const DataIn /*!< The port*/
      );
    ...
    protected:
      ...
      //! Construct object MotionTrackingTesterBase
      //!
      ...
      //! Destroy object MotionTrackingTesterBase
      //!
      virtual ~MotionTrackingTesterBase(void);
    ...
    protected:
      ...
      //! Handle channel MOTIONTRACKING_ANGLES
      //!
      virtual void tlmInput_MOTIONTRACKING_ANGLES(
          const Fw::Time& timeTag, /*!< The time*/
          const App::AnglesTlm& val /*!< The channel value*/
      );

      //! A telemetry entry for channel MOTIONTRACKING_ANGLES
      //!
      typedef struct {
        Fw::Time timeTag;
        App::AnglesTlm arg;
      } TlmEntry_MOTIONTRACKING_ANGLES;

      //! The history of MOTIONTRACKING_ANGLES values
      //!
      History<TlmEntry_MOTIONTRACKING_ANGLES>
        *tlmHistory_MOTIONTRACKING_ANGLES;
    ...
    protected:
      ...
      //! Handle channel MOTIONTRACKING_GYRO
      //!
      virtual void tlmInput_MOTIONTRACKING_GYRO(
          const Fw::Time& timeTag, /*!< The time*/
          const App::VectorTlm& val /*!< The channel value*/
      );

      //! A telemetry entry for channel MOTIONTRACKING_GYRO
      //!
      typedef struct {
        Fw::Time timeTag;
        App::VectorTlm arg;
      } TlmEntry_MOTIONTRACKING_GYRO;

      //! The history of MOTIONTRACKING_GYRO values
      //!
      History<TlmEntry_MOTIONTRACKING_GYRO>
        *tlmHistory_MOTIONTRACKING_GYRO;
    ...
    protected:
      ...
      //! Handle channel MOTIONTRACKING_ACCEL
      //!
      virtual void tlmInput_MOTIONTRACKING_ACCEL(
          const Fw::Time& timeTag, /*!< The time*/
          const App::VectorTlm& val /*!< The channel value*/
      );

      //! A telemetry entry for channel MOTIONTRACKING_ACCEL
      //!
      typedef struct {
        Fw::Time timeTag;
        App::VectorTlm arg;
      } TlmEntry_MOTIONTRACKING_ACCEL;

      //! The history of MOTIONTRACKING_ACCEL values
      //!
      History<TlmEntry_MOTIONTRACKING_ACCEL>
        *tlmHistory_MOTIONTRACKING_ACCEL;
    ...
    protected:
      ...
      //! Handle channel MOTIONTRACKING_MAGN
      //!
      virtual void tlmInput_MOTIONTRACKING_MAGN(
          const Fw::Time& timeTag, /*!< The time*/
          const App::VectorTlm& val /*!< The channel value*/
      );

      //! A telemetry entry for channel MOTIONTRACKING_MAGN
      //!
      typedef struct {
        Fw::Time timeTag;
        App::VectorTlm arg;
      } TlmEntry_MOTIONTRACKING_MAGN;

      //! The history of MOTIONTRACKING_MAGN values
      //!
      History<TlmEntry_MOTIONTRACKING_MAGN>
        *tlmHistory_MOTIONTRACKING_MAGN;
    ...
    private:
      ...
      //!
      App::OutputICMPortPort m_to_DataIn[1];

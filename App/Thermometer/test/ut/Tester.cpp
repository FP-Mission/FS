// ====================================================================== 
// \title  Thermometer.hpp
// \author root
// \brief  cpp file for Thermometer test harness implementation class
//
// \copyright
...
namespace App {
  ...
  Tester ::
    Tester(void) : 
      ...
      ThermometerGTestBase("Tester", MAX_HISTORY_SIZE),
      component("Thermometer")
#else
      ThermometerGTestBase(MAX_HISTORY_SIZE),
      component()
#endif
  {
    this->initComponents();

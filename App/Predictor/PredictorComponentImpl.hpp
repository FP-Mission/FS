...
namespace App {
  ...
  class PredictorComponentImpl :
    public PredictorComponentBase
  {
    ...
    PRIVATE:
      ...
      void position_handler(
          ...
          I32 latitude, /*!< Latitude in ? @todo*/
          I32 longitude, /*!< Longitude in ? @todo*/
    ...
    PRIVATE:
      ...
      //! Set prediction rate
      void Predi_SetPredictionRate_cmdHandler(
          const FwOpcodeType opCode, /*!< The opcode*/
          const U32 cmdSeq, /*!< The command sequence number*/
          U8 rate /*!< Prediction rate. Set to 0 to disable. 1 means each time the position is sent to the predictor it will estimate landing position.*/
      );

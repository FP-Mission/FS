...
namespace App {
  ...
  void SenseHatGTestBase ::
    assert_from_SHT_size(
        const char *const __callSiteFileName,
        const U32 __callSiteLineNumber,
        const U32 size
    ) const
  {
    ASSERT_EQ(size, this->fromPortHistory_SHT->size())
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
      << "  Value:    Size of history for from_SHT\n"
      << "  Expected: " << size << "\n"
      << "  Actual:   " << this->fromPortHistory_SHT->size() << "\n";
  }
  ...
  void SenseHatGTestBase ::
    assert_from_LPS_size(
        const char *const __callSiteFileName,
        const U32 __callSiteLineNumber,
        const U32 size
    ) const
  {
    ASSERT_EQ(size, this->fromPortHistory_LPS->size())
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
      << "  Value:    Size of history for from_LPS\n"
      << "  Expected: " << size << "\n"
      << "  Actual:   " << this->fromPortHistory_LPS->size() << "\n";
  }
  ...
  void SenseHatGTestBase ::
    assert_from_ICM_size(
        const char *const __callSiteFileName,
        const U32 __callSiteLineNumber,
        const U32 size
    ) const
  {
    ASSERT_EQ(size, this->fromPortHistory_ICM->size())
      << "\n"
      << "  File:     " << __callSiteFileName << "\n"
      << "  Line:     " << __callSiteLineNumber << "\n"
      << "  Value:    Size of history for from_ICM\n"
      << "  Expected: " << size << "\n"
      << "  Actual:   " << this->fromPortHistory_ICM->size() << "\n";
  }

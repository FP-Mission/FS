// ======================================================================
// \title  Barometer/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for Barometer component test harness base class
//
// \copyright
...
#ifndef Barometer_TESTER_BASE_HPP
#define Barometer_TESTER_BASE_HPP
...
namespace App {
  ...
  //! \class BarometerTesterBase
  //! \brief Auto-generated base class for Barometer component test harness
  //!
  class BarometerTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object BarometerTesterBase
      //!
      virtual void init(
    ...
    public:
      ...
      void connect_to_DataIn(
          ...
          App::InputLPSPortPort *const DataIn /*!< The port*/
      );
    ...
    protected:
      ...
      //! Construct object BarometerTesterBase
      //!
      BarometerTesterBase(
      ...
      //! Destroy object BarometerTesterBase
      //!
      virtual ~BarometerTesterBase(void);
    ...
    protected:
      ...
      //! Handle channel BAROMETER_TEMP
      //!
      virtual void tlmInput_BAROMETER_TEMP(
          const Fw::Time& timeTag, /*!< The time*/
          const F32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel BAROMETER_TEMP
      //!
      typedef struct {
        Fw::Time timeTag;
        F32 arg;
      } TlmEntry_BAROMETER_TEMP;

      //! The history of BAROMETER_TEMP values
      //!
      History<TlmEntry_BAROMETER_TEMP>
        *tlmHistory_BAROMETER_TEMP;
    ...
    protected:
      ...
      //! Handle channel BAROMETER_PRESS
      //!
      virtual void tlmInput_BAROMETER_PRESS(
          const Fw::Time& timeTag, /*!< The time*/
          const F32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel BAROMETER_PRESS
      //!
      typedef struct {
        Fw::Time timeTag;
        F32 arg;
      } TlmEntry_BAROMETER_PRESS;

      //! The history of BAROMETER_PRESS values
      //!
      History<TlmEntry_BAROMETER_PRESS>
        *tlmHistory_BAROMETER_PRESS;
    ...
    protected:
      ...
      //! Handle channel BAROMETER_ALT
      //!
      virtual void tlmInput_BAROMETER_ALT(
          const Fw::Time& timeTag, /*!< The time*/
          const U16& val /*!< The channel value*/
      );

      //! A telemetry entry for channel BAROMETER_ALT
      //!
      typedef struct {
        Fw::Time timeTag;
        U16 arg;
      } TlmEntry_BAROMETER_ALT;

      //! The history of BAROMETER_ALT values
      //!
      History<TlmEntry_BAROMETER_ALT>
        *tlmHistory_BAROMETER_ALT;
    ...
    private:
      ...
      //!
      App::OutputLPSPortPort m_to_DataIn[1];
